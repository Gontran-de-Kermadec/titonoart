			...
			<div>
				<div className="about__child about__origin">
					<div className="about__origin--children about__origin--first">
						...
						<p>
							Ti TONO ART propose des créations exclusives de styles, de motifs,
							et de couleurs variés sur une matière noble : le Bois !
						</p>
						<p>
							Ces objets destinés à la décoration d’intérieur sont réalisés
							selon l’inspiration de l'artiste ou sur votre demande.
						</p>
						<p>
							Touche exotique, atmosphère tropicale, l’art de vivre « à
							l’antillaise », esprit Caraïbes, couleurs vives...
						</p>
						<p>
						...
						<p>
							Nous voulons que vous vous sentiez bien chez vous, dans un univers
							qui vous ressemble.
						</p>
					</div>
					{/*<div className="about__origin--children about__origin--second">
						...
						<p>
							Sur une idée originale de Delphine, évoluant dans le monde des
							spiritueux, et de Robin, artiste tatoueur et illustrateur, TI TONO
							ART aété créé en 2021.
						</p>
						<p>
							"Ce concept vous propose une Pièce de décoration que vous ne
							trouverez nulle par ailleurs".
						</p>
						<p>
							Consommer moins et consommer mieux, c’est possible avec le
							savoir-faire local.
						</p> 
					</div>
				...
				{/*<div className="about__child about__support">
					...
					<p>
						...
						depuis 3 générations et le respect des matières et de
						l’environnement.
					</p>
					<p>
						...
						Naturellement imprégné des ubtils arômes de fruits rouges et
						vanillés.
					</p>
					<div>
						<img src={fut} alt="" />
					...
					<p>
						{" "}
						Nous permettons à ce jeune fût de perdurer dans le temps et de
						devenir une pièce authentique, atypique et surtout unique.
					</p>
					<p>
				...
				<div className="about__child about__valeur">
					...
					<p>LA PASSION</p>
					<p>
						Cette activité est exercée en plus de nos professions respectives.
						Nous la vivons donc par amour de l’art.
					</p>
					<p>LA PERSONNALISATION</p>
					<p>Nous proposons un produit à caractère unique.</p>
					<p>L'ENVIRONNEMENT</p>
					<p>
						« Créer » veut aussi parfois dire « recycler », la préservation de
						l’environnement est essentielle.Notre façon de consommer peut être
						plus qualitative et durable.
					</p>
					<div>
						<img src={support} alt="" />
					</div>
				...
				<div className="about__child about__demarche">
					...
					<p>
						...
						les poumons indispensables de notre planète. Conscient de
						l’importance de la protection des forêts, Ti Tono Art s’engage
						auprès de REFOREST'ACTION.
					</p>
			...
			<div>
				<div className="about__subsections">
					<div className="about__subsection">
						<h3 className="subsection__origin--title">L'origine</h3>
